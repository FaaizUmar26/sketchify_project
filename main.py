...
import subprocess #used to interact with operating sysytem.seal with new processes connect with the input/output
# and obtain the output.
from PIL import Image, ImageTk #image is used for opening manipulating  saving various images
