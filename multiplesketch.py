...
from tkinter import filedialog# displaying message boxes in a graphical user interface (GUI) application.
from PIL import Image, ImageTk# displaying message boxes in a graphical user interface (GUI) application.
...
def apply_sketch_effect(image):
    ...
    # Invert the grayscale image grayscale remove complexity.
    inverted = cv2.bilateralFilter(gray, 9, 300, 300)

    # Apply Gaussian blur to the inverted image,guassian blurr is used to reduce the size of an image
